        ...
        <?php 
			...
			if($r > 0){
				...
				<div class='alert alert-warning'>
					...
					<span class='pull-right'><a href='index.php?page=produk&stok=yes'>Cek produk <i class='fa fa-angle-double-right'></i></a></span>
				</div>
				";	
			}
		?>
        ...
        <a href="index.php?page=produk&stok=yes" class="btn btn-warning btn-md mr-2">
                ...
                <table class="table table-bordered table-striped table-sm" id="example1">
					...
					?>
                        <tr>
                            ...
                            <td> <?php echo $isi['satuan_produk'];?></td>
                            <td>
                                <?php if($isi['stok'] <=  '3'){?>
                                <form method="POST" action="fungsi/edit/edit.php?stok=edit">
                                    <input type="text" name="restok" class="form-control">
                                    <input type="hidden" name="id" value="<?php echo $isi['id_produk'];?>"
                                        class="form-control">
                                    <button class="btn btn-primary btn-sm">
                                        Restok
                                    </button>
                                    <a href="fungsi/hapus/hapus.php?produk=hapus&id=<?php echo $isi['id_produk'];?>"
                                        onclick="javascript:return confirm('Hapus Data produk ?');">
                                        <button class="btn btn-danger btn-sm">Hapus</button></a>
                                </form>
                                <?php }else{?>
                                <a href="index.php?page=produk/details&produk=<?php echo $isi['id_produk'];?>"><button
