	...
	<div class="table-responsive">
		<table class="table table-striped">
			<form action="fungsi/edit/edit.php?produk=edit" method="POST">
				<tr>
					<td>ID produk</td>
					<td><input type="text" readonly="readonly" class="form-control" value="<?php echo $hasil['id_produk'];?>"
							name="id"></td>
				</tr>
				<tr>
					<td>Kategori</td>
				...
				<tr>
					...
					<td>
						<select name="satuan" class="form-control">
							<option value="<?php echo $hasil['satuan_produk'];?>"><?php echo $hasil['satuan_produk'];?>
							</option>
