...
<?php
		...
		<div class='alert alert-warning'>
			...
			<span class='pull-right'><a href='index.php?page=produk&stok=yes'>Tabel produk <i class='fa fa-angle-double-right'></i></a></span>
		</div>
		";	
	}
?>
<?php $hasil_produk = $lihat -> produk_row();?>
<?php $hasil_kategori = $lihat -> kategori_row();?>
<?php $stok = $lihat -> produk_stok_row();?>
...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            ...
            <div class="card-body">
                <center>
                    <h1><?php echo number_format($hasil_produk);?></h1>
                </center>
            </div>
            <div class="card-footer">
                <a href='index.php?page=produk'>Tabel
